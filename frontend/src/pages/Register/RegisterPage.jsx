...
export default function RegisterPage() {
  ...
  if (loading) {
    return <div className="register-container"><div className="loading-spinner">Loading...</div></div>
  }
    ...
    return (
      <div className="register-container">
        <div className="register-card error-card">
          ...
          <h2 className="error-title">Registration Unavailable</h2>
          <p className="error-message">{error}</p>
          <p className="error-help">Please contact the administration office for a new registration link.</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="register-container">
        <div className="register-card success-card">
          ...
          <p className="success-message">Your vehicle registration application has been submitted successfully and is pending review.</p>
          <p className="success-help">You will receive an email notification once your application has been processed.</p>
          <button className="btn-return" onClick={() => navigate('/login')}>Return to Login</button>
        </div>
      </div>
    )
  }
    ...
    <div className="register-container">
      <div className="register-card">
        <div className="register-header">
          {/* Use a placeholder div if logo isn't available, but we import it just in case */}
          <div className="logo-placeholder">SLC</div>
          <h1 className="register-title">Vehicle Registration</h1>
          <p className="register-subtitle">Saint Louis College</p>
          <div className="registrant-badge">{registrantType === 'student' ? 'Student Registration' : 'Employee Registration'}</div>
        </div>
