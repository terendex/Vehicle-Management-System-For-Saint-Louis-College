...
export const HELP_TOPICS = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'p', text: 'Two panels appear on the right only when they have something in them. Unrecognized Vehicles Inside lists the no-plate vehicles still on campus, with a Slip button to reprint or exit from, and a Log Exit button. Overstaying lists vehicles past the maximum stay their entry rule allows, with how far over they are.' },
