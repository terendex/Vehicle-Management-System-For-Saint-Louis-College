...
export const HELP_TOPICS = [
  ...
  },
  {
    ...
    roles: ['admin'],
    body: [
      { type: 'p', text: 'Management › Visits and Suppliers has two tabs. Suppliers holds the supplier companies and their plates, which are admitted automatically when scanned at the gate, within the supplier delivery window. Scheduled Visits books the visitors and suppliers expected on a given date.' },
      ...
      { type: 'p', text: 'Any visit that has not arrived yet, a No-show included, can be moved with Reschedule: the same booking, with the same SV number, appears in Expected Today on its new date. Visits are archived rather than deleted. Archive takes an optional reason and moves the visit to the Archived view, where it stays on record with who archived it and when; the gate stops seeing it. Restore brings it back.' },
