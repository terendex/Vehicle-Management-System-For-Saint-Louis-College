...
PH_PLATE_PATTERNS = [
    ...
    # through as "valid" plates. The pure-4-digit pattern ([0-9]{4}, old
    # motorcycle) was removed for the same reason: any partial read of a
    # plate's digit block (AEB946 → "1946") passed as a valid plate.
]
