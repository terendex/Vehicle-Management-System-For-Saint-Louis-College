...
urlpatterns = [
    ...
    path('slip/',                            views.SlipView.as_view(),              name='slip'),
    path('slip/print/',                      views.SlipPrintView.as_view(),         name='slip-print'),
    path('slip/reprinted/',                  views.SlipReprintedView.as_view(),     name='slip-reprinted'),
    path('slip/exit/',                       views.SlipExitView.as_view(),          name='slip-exit'),
