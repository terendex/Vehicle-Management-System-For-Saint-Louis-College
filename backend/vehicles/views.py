...
from .models import Vehicle, RuleConstraint, ParkingSpace, ParkingZone, ReferenceItem, SystemSettings, ParkingNotice
from .serializers import VehicleSerializer, RuleConstraintSerializer, ParkingSpaceSerializer, ParkingZoneSerializer, ReferenceItemSerializer, ParkingNoticeSerializer
